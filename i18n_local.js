...
const CCB_I18N_MESSAGES = {
  "en": {
    ...
    "diagnosticButton": "Technical diagnostic",
    "settingsButton": "Settings",
    "statusReady": "v1.0.0-rc5 — backend API + session token.",
    ...
    "showDiagnostic": "Technical diagnostic",
    ...
    "standardModeHelp": "“Minimal” shows only the default export action. “Standard” shows readable exports only. “Advanced” shows the main export modes. “Custom” uses the checkboxes below, including the technical diagnostic if enabled.",
  ...
  "fr": {
    ...
    "diagnosticButton": "Diagnostic technique",
    "settingsButton": "Paramètres",
    "statusReady": "v1.0.0-rc5 — API backend + token de session.",
    ...
    "showDiagnostic": "Diagnostic technique",
    ...
    "standardModeHelp": "« Minimal » affiche uniquement l’action d’export par défaut. « Standard » affiche seulement les exports lisibles. « Avancé » affiche les principaux modes d’export. « Personnalisé » utilise les cases ci-dessous, y compris le diagnostic technique s’il est activé.",
